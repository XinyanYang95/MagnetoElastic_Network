...
#[MAG]
magr = 1/16*2.54 # 1/16 inch magnet (cm) [RADIUS]
tm = 1/4*25.4   # in mm [HIGHT]
Br = 1.31 # in T (~N42) [FLUX]
mag_mass = 0.377/1000  # in kg (from K&J magnet spec.s) [MASS]
#[MAG]
...
# [SYS]
eps=3e-2 # [mageps = eps # LJ 12-6 energy well depth (for magnetic dipole-dipole repulsion calc), float (in J).]
...
@jax.jit
def Energy_mag_steric_repulsion_map(pair, magr, pos, eps=3.0e-2):
...
dt = 2e-7 # timestep [s]
t_tot = 8.0 # total simulation time [s]
...
fin_box = 10.0 # final box size 10x10
